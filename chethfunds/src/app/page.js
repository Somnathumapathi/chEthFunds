...
export default function Home() {
  ...
  const card = `flex flex-col rounded-xl p-5 w-1/2 min-h-[220px] items-center justify-center bg-gray-950/30 border- border-purple-900 transition-all duration-500 ease-in-out transform hover:scale-105`
  ...
  return (
    <>
    <div className="flex flex-col items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)] bg-transparent">
      <h1 className="text-3xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-br from-purple-600 to-pink-700 border-b-8 border-purple-800 -pb-4">ChETH FUNDS</h1>
      <ConnectButton />
